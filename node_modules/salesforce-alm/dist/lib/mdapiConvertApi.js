...
class MdapiConvertApi {
    ...
    convertSource(org) {
        ...
        return org.resolveDefaultName()
            ...
            const sourceWorkspaceAdapter = new SourceWorkspaceAdapter(org, path.relative(this.projectPath, this.outputDirectory), true, MetadataRegistry);
            sourceWorkspaceAdapter.fromMdapiConvert = true;
