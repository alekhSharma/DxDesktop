...
class SourceConvertApi {
    constructor(org) {
        ...
        this.sourceWorkspaceAdapter = new SourceWorkspaceAdapter(this.scratchOrg, defaultPackagePath, true, MetadataRegistry);
    ...
    convertSourceToMdapi(targetPath, packageName, aggregateSourceElementsMap, createDestructiveChangesManifest, unsupportedMimeTypes) {
        ...
        return Promise.resolve()
            ...
            if (createDestructiveChangesManifest) {
                return SourceConvertApi.createPackageManifests(targetPath, packageName, destructiveChangesTypeNamePairs, sourceElementsForMdDir, this.scratchOrg);
            }
