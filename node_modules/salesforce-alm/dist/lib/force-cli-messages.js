...
let locale = 'en_US';
exports.get = function (label, ...args) {
    if (!messages[locale]) {
    ...
    if (args) {
        ...
        if (args.length !== expectedNumArgs) {
            Error.exitWithMessage('Wrong number of args for message: ' + label + '\nExpect ' + expectedNumArgs + ' got ' + args.length);
        }
...
const DATA_RECORD_HELP = 'The format of a field-value pair is <fieldName>=<value>.' +
    '\nEnclose all field-value pairs in one set of double quotation marks, delimited by spaces.' +
    '\nEnclose values that contain spaces in single quotes.';
const DATA_BULK_HELP = 'One job can contain many batches, depending on the length of the CSV file.' +
...
let messages = {
    en_US: {
        ...
        ApexExecHelp: 'Executes one or more lines of Apex code, or executes the code in a local file.' +
        ...
        ApexExecTypingPrompt: '>> Start typing Apex code. Press the Enter key after each line, ' +
            '\n>> then press CTRL+D when finished.',
        ...
        ApexLimitsLongDescription: 'Displays the maximum Apex governor limits for your org. ' +
        ...
        ApiLimitsHelp: 'When you execute this command in a project, it provides limit information for your default scratch org.' +
            '\n\nExamples:\n   $ sfdx force:limits:api:display' +
            '\n   $ sfdx force:limits:api:display -u me@my.org',
        ApexLogGetDescription: 'fetch a debug log',
        ApexLogGetLongDescription: 'Fetches a specific debug log.',
        ApexLogGetHelp: 'When you execute this command in a project, it fetches the specified log from your default scratch org.' +
        ...
        ApexLogListHelp: 'When you execute this command in a project, it lists the log IDs for your default scratch org.' +
        ...
        DataBulkDeleteHelp: 'The file must be a CSV file with only one column: "Id".' +
            '\n' + DATA_BULK_HELP +
        ...
        DataBulkDeleteCsvFilePathLongDescription: 'The path to the CSV file that contains the IDs of the records to delete.',
        ...
        DataBulkStatusJobIdLongDescription: 'The ID of the job you want to view or of the job whose batch you want to view.',
        ...
        DataBulkStatusNoBatchFound: 'Unable to find batch %s for job %s.',
        DataBulkStatusJobError: 'Unable to retrieve status of job %s.',
        DataBulkUpsertDescription: 'bulk upsert records from a CSV file',
        DataBulkUpsertLongDescription: 'Creates a job and one or more batches for inserting new rows and updating ' +
            'existing rows by accessing the Bulk API.',
        DataBulkUpsertHelp: 'Inserts or updates records from a CSV file. ' +
            '\n' + DATA_BULK_HELP +
        ...
        DataBulkUpsertExternalIdRequired: 'An External ID is required on %s to perform an upsert.',
        DataBulkUpsertCheckStatusCommand: 'Check batch #%s’s status with the command:' +
            '\nsfdx force:data:bulk:status -i %s -b %s',
        DataBulkUpsertPollingInfo: 'Will poll the batch statuses every %s seconds' +
            '\nTo fetch the status on your own, press CTRL+C and use the command:' +
            '\nsfdx force:data:bulk:status -i %s -b [\<batchId>]',
        DataBulkUpsertBatchQueued: 'Batch #%s queued (Batch ID: %s).',
        DataBulkTimeOut: 'The operation timed out. Check the status with command:' +
            '\nsfdx force:data:bulk:status -i %s -b %s',
        ...
        DataRecordCreateHelp: DATA_RECORD_HELP +
        ...
        DataRecordCreateSuccess: 'Successfully created record: %s.',
        DataRecordCreateFailure: 'Failed to create record. %s',
        DataRecordDeleteDescription: 'delete a record',
        DataRecordDeleteLongDescription: 'Deletes a single record.',
        DataRecordDeleteHelp: 'Specify an sObject type and either an ID or a list of <fieldName>=<value> pairs.' +
            '\n' + DATA_RECORD_HELP + '\n\nExamples:' +
            ...
            '\n   $ sfdx force:data:record:delete -t -s TraceFlag -i 7tf170000009cU6AAI',
        ...
        DataRecordDeleteSuccess: 'Successfully deleted record: %s.',
        DataRecordDeleteFailure: 'Failed to delete record. %s',
        DataRecordGetDescription: 'view a record',
        DataRecordGetLongDescription: 'Displays a single record.',
        DataRecordGetHelp: 'Specify an sObject type and either an ID or a list of <fieldName>=<value> pairs.' +
            '\n' + DATA_RECORD_HELP + '\n\nExamples:' +
            ...
            '\n   $ sfdx force:data:record:get -t -s TraceFlag -i 7tf170000009cUBAAY',
        ...
        DataRecordGetIdFormatError: 'Could not parse field value %s. Expected format \<fieldName>=<value>.',
        DataRecordUpdateDescription: 'update a record',
        DataRecordUpdateLongDescription: 'Updates a single record.',
        DataRecordUpdateHelp: DATA_RECORD_HELP +
            '\n\nExamples:' +
        ...
        DataRecordUpdateSuccess: 'Successfully updated record: %s.',
        DataRecordUpdateFailure: 'Failed to update record. %s',
        DataSOQLQueryDescription: 'execute a SOQL query',
        DataSOQLQueryLongDescription: 'Executes a SOQL query.',
        DataSOQLQueryHelp: 'When you execute this command in a project, ' +
        ...
        DataSOQLQueryResultFormatDescription: 'query result format emitted to stdout; --json flag overrides this parameter',
        DataSOQLQueryResultFormatLongDescription: 'Format to use when displaying query results. If you also specify the --json flag, --json overrides this parameter.',
        ...
        DataSOQLQueryMoreMissingRecords: 'Server response is missing the next records; cannot display the rest of the results.',
        DataSOQLQueryInvalidReporter: 'Unknown result format type. Must be one of the following values: %s',
        DisplayWarning: 'WARNING: %s',
        ...
        ErrorError: 'ERROR: ',
        ErrorAbort: 'ABORTED',
        ResponseParserStatusError: 'Could not parse status information from server response: %s.',
        ResponseParserDebugError: 'Could not parse debug information from server response: %s.',
        ...
        SchemaDeleteFailure: 'Deletion failed for %s %s.',
        SchemaDeleteSuccess: 'Successfully deleted %s %s.',
        SchemaDeleteCantDeleteStandard: 'You can’t delete standard objects. Did you forget the "__c" suffix?',
        SchemaDeleteInvalidObjectName: 'Unable to parse API name: %s',
        SchemaDeleteExistingData: 'Deleting this field/object will delete all associated data.' +
        ...
        SchemaSObjectDescribeHelp: 'Examples:\n   $ sfdx force:schema:sobject:describe -s Account' +
        ...
        SchemaSObjectListHelp: 'Lists all objects, custom objects, or standard objects in the org.' +
        ...
        SchemaSObjectListObjectOfTypeNotFound: 'No %s objects found.',
        SourceOpenDescription: 'edit a Lightning Page with Lightning App Builder',
        SourceOpenLongDescription: 'Opens the specified Lightning Page in Lightning App Builder. Lightning Page ' +
        ...
        SourceOpenHelp: 'The editor opens in your default browser.' +
        ...
        SourceOpenCommandUnpushedError: 'no metadata in Salesforce org (consider executing source:push)',
...
//# sourceMappingURL=force-cli-messages.js.map
